...
Предположим у нас такая ситуация, тогда из таблицы **orders** данные нужно распределить по партициям,
...
На практике с очень большим объемом данных, я думаю такие задачи решаются с помощью реплик и переключением бэкендов
на разные сервера СУБД.
...
IMHO, на практике я думаю что это задание на несколько дней продуманной работы минимум.
